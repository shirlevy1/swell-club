 ...
 *
 * הבסיס תמיד "אני מגיע/ה" (גוף ראשון, byGender) — לא הופך ל"אתם
 * מגיעים" כשמסומן/ת, בדיוק כמו RsvpButton המקורי (ראו AGENTS.md,
 * "עברית": זה החריג המכוון היחיד לפנייה ברבים). "סמנו · " מתווסף
 * לפניו רק כל עוד לא סימנו — קריאה לפעולה שנעלמת ברגע שכבר סימנתם,
 * ולא רק צבע כדי להבחין בין "מסומן" ל"לא מסומן". המילוי (ירוק-verified
 * מלא + סימן ✓ מול מסגרת שקופה בלבד) נשאר ההבדל השני, המשלים.
 *
