 ...
 * מייל אין לו/ה שום דרך לגלות שיש למה לחזור. כפתור "התחברות" במייל
 * הוא קישור איפוס סיסמה אמיתי (לא /login), כי סביר שהאדם לא זוכר/ת
 * סיסמה. המנהלת מקבלת התראה על כך שהוא/היא חזר/ה רק אחרי שממש
 * מגדיר/ה סיסמה חדשה (update-password) — לא כאן, כי כאן היא כבר יודעת.
 */
