...
/**
 * "איך הים השבוע" — גרסת "אופק": כל יום הוא עמודה שמדמה את גובה
 * הגל בפועל — נמוכה וכחולה = ים רגוע, גבוהה ואפורה = ים סוער. ראו
 * lib/sea-score.ts לנוסחה. שורה אחת קבועה, בלי גלילה.
 */
    ...
    >
      ...
      <div className="relative mt-4 flex h-28 items-end justify-between gap-1.5">
        ...
        {days.map((d) => {
          ...
          // הפוך מהציון: ים רגוע (ציון גבוה) הוא גל נמוך, ים סוער
          // (ציון נמוך) הוא גל גבוה — כמו גובה הגל האמיתי, לא "כמה טוב".
          const heightPct = Math.max(12, ((5 - d.stars) / 5) * 100);
          return (
