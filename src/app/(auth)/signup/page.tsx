        ...
        <div className="space-y-3">
          <div className="max-h-64 space-y-4 overflow-y-auto rounded-xl border border-(--color-line) bg-(--color-haze) p-4 text-xs leading-relaxed text-(--color-ink-soft)">
            <div className="space-y-2">
              ...
              <p>
                בעמוד המפגשים אנחנו טוענים אריחי מפה מ-CartoDB, ובזמן
                צ׳ק־אין נטען קובץ זיהוי פנים מ-jsDelivr (CDN) - כמו כל
                אתר, השירותים האלה יכולים לראות את כתובת ה-IP שלכם
                בזמן הטעינה.
              </p>
              <p>
                זיהוי הפנים בצ׳ק־אין רץ כולו בדפדפן שלכם - לא נשלח
                לשום שרת חיצוני, ומשמש רק למיקום התמונה. לא נשמרת
                שום &quot;טביעת פנים&quot; - רק הסלפי עצמו.
              </p>
            </div>
