...
export async function POST(request: Request) {
  ...
  let event: { id?: string; starts_at: string; location_name: string } = {
    starts_at: new Date(
  ...
  const payload = JSON.stringify(buildReminderPayload(reminderKind, event));
