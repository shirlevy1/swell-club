-- ============================================================================
-- Swell — רמת שחייה בפרופיל
-- ============================================================================
-- nullable בכוונה, בדיוק כמו gender — הכפייה ל"חובה" קורית בטופס
-- (ההרשמה ועריכת הפרופיל), לא כאילוץ במסד. אחרת פרופילים קיימים בלי
-- הערך הזה היו שוברים את המיגרציה.
-- ============================================================================

create type public.swim_level as enum ('entering', 'flowing', 'deepening');

alter table public.profiles add column swim_level public.swim_level;
