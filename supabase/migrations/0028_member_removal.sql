...
-- כרגע כמשימה עתידית.
--
-- [עדכון, migration 0036]: המשימה הזו בוצעה. השורה כבר לא נמחקת בכלל
-- (status='removed' במקום DELETE), ויש מסך שחזור למנהלת. ההערה למעלה
-- נשארת כתיעוד היסטורי של ההחלטה המקורית.
--
